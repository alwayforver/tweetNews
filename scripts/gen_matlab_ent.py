...
if __name__ == "__main__":
    ...
    if len(args) != 9:
        op.error("this script takes 9 arguments: news_input_prefix start_date end_date tweets_input_prefix num_clus t_topK all/text/snippets outfile")
        sys.exit(1)
...
#        curr_t = (ind2obj[i].created_at - s_dt).days+2
    ...
    X_per,terms_per = getEntMat(ind2obj,0,ent_count,thresh)
    print("per entity done")
    X_loc,terms_loc = getEntMat(ind2obj,1,ent_count,thresh)
    print("loc entity done")
    X_org,terms_org = getEntMat(ind2obj,2,ent_count,thresh)
...
#    XX = XX.tocsr()
    ...
    sio.savemat('/home/jwang112/Dropbox/linux_buffer/testX_thresh_'+str(thresh)+'K_'+str(k)+'.mat',
